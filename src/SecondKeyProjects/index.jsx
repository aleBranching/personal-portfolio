...
import ProjectCardBattleship from "./ProjectCardBattleship";
import ProjectCardMern from "./ProjectCardMern";
import ProjectCardTelegramBot from "./ProjectCardTelegramBot";
  ...
  return (
    ...
    >
      ...
      <ProjectCard
        ...
        repoURL={"https://github.com/aleBranching/odin-battleships/tree/main/"}
      >
      ...
      >
        ...
        <li>
          Allows for 3 searches in indeed every 15-30min and send you a message
          about new jobs
        </li>
...
export default SecondKeyProjects;
